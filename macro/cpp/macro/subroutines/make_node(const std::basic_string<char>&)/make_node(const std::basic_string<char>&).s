	...
	.type	make_node(const std::basic_string<char>&), %function
make_node(const std::basic_string<char>&):
.LFB1656:
	.cfi_startproc
...
.LLSDACSE1656:
	.text
	.size	make_node(const std::basic_string<char>&), .-make_node(const std::basic_string<char>&)
	.align	2
	.global	destroy_node(Node*)