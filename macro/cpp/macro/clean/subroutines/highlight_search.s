...
.LFB1677:
	...
	str	w2, [sp, 28]	// y, y
// main.cpp:239:     attron(COLOR_PAIR(1)); // Turn on color pair 1 (black on yellow)
	...
	mov	w1, 256	//,
	bl	wattr_on		//
// main.cpp:240:     for (size_t i = 0; i < search_length; i++)
	str	xzr, [sp, 56]	//, i
// main.cpp:240:     for (size_t i = 0; i < search_length; i++)
	b	.L65		//
.L69:
// main.cpp:242:         chtype original_char = mvinch(y, found_pos + i);                  // Get the original character at the current position
...
// main.cpp:243:         chtype new_char = (original_char & A_CHARTEXT) | (COLOR_PAIR(1)); // Combine the original character with the color pair
	ldr	w0, [sp, 52]	// tmp118, original_char
	and	w0, w0, 255	// _9, tmp118,
// main.cpp:243:         chtype new_char = (original_char & A_CHARTEXT) | (COLOR_PAIR(1)); // Combine the original character with the color pair
	orr	w0, w0, 256	// tmp119, _9,
	str	w0, [sp, 48]	// tmp119, new_char
// main.cpp:244:         mvaddch(y, found_pos + i, new_char);                              // Print the new character to the screen
...
// main.cpp:240:     for (size_t i = 0; i < search_length; i++)
	...
	bcc	.L69		//,
// main.cpp:246:     attroff(COLOR_PAIR(1)); // Turn off color pair 1
